...
%%%%%%%%%%%%%%%%%%%%%%%%% TIEMPO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tf=23.7;             % Tiempo de simulación en segundos (s)
...
v = [0*ones(1,10)      1*ones(1,20)    0*ones(1,10)     1*ones(1,20)   0*ones(1,10)       1*ones(1,10)    0*ones(1,10)       1*ones(1,5)      0*ones(1,10)       1*ones(1,14)     0*ones(1,10)       1*ones(1,5)     0*ones(1,10)         1*ones(1,15)    0*ones(1,10)          1*ones(1,14)    0*ones(1,10)        1*ones(1,10)    0*ones(1,10)        1*ones(1,14)    0*ones(1,11)]; % Velocidad lineal de referencia (m/s)
w = [pi/2*ones(1,10)   0*ones(1,20)   -pi/4*ones(1,10)  0*ones(1,20)  -pi/4*ones(1,10)    0*ones(1,10)   -pi/2*ones(1,10)    0*ones(1,5)     -pi/4*ones(1,10)    0*ones(1,14)    -pi/4*ones(1,10)    0*ones(1,5)     pi/2*ones(1,10)      0*ones(1,15)    3*pi/4*ones(1,10)     0*ones(1,14)    -pi/4*ones(1,10)    0*ones(1,10)    -pi/4*ones(1,10)    0*ones(1,14)    3*pi/4*ones(1,11)]; % Velocidad angular de referencia (rad/s)
